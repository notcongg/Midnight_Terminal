...
class Extensions:
    ...
    native process execution DLL (Windows only).

    On non-Windows platforms, this class provides a
    ...
    def __init__(self) -> None:
        ...
        if platform.system() == "Windows":
            self._load_windows_dll()
        else:
            # Linux/Mac: use subprocess fallback
            self._use_fallback = True

    def _load_windows_dll(self) -> None:
        """Load the native Windows DLL."""
    ...
    def _call_fallback(
        ...
        """
        Fallback implementation using subprocess for non-Windows platforms.
        """
        import subprocess
